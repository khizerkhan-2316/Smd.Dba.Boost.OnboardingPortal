export const LOGIN_ENDPOINT = `${process.env.REACT_APP_API_BASE_URL}/authentication/login`;
export const RESET_PASSWORD_ENDPOINT = `${process.env.REACT_APP_API_BASE_URL}/authentication/reset-password`;
