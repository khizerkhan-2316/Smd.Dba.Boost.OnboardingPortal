...
public class UserService : IUserService
{
    ...
    public async Task<IEnumerable<UserDto>> GetUsersByCompanyIdAsync(Guid companyId, CancellationToken cancellationToken)
    {
        return _mapper.Map<IEnumerable<UserDto>>(
            await _userRepository.GetUsersByCompanyId(companyId, cancellationToken));
    }
    ...
    public async Task UpdateUserByIdAsync(Guid id, UserDto user, CancellationToken token)
    {
        ...
        await _userRepository.UpdateUserAsync(id, _mapper.Map<User>(user), token);
    }
